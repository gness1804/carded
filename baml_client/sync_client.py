...
class BamlSyncClient:
    ...
    def ExtractBusinessCard(self, image: baml_py.Image,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractBusinessCard", args={
                "image": image,
            })
...
class BamlStreamClient:
    ...
    def ExtractBusinessCard(self, image: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.BusinessCard, types.BusinessCard]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractBusinessCard", args={
            "image": image,
        })
        return baml_py.BamlSyncStream[stream_types.BusinessCard, types.BusinessCard](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ExtractBusinessCard(self, image: baml_py.Image,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractBusinessCard", args={
            "image": image,
        }, mode="request")
        return __result__
